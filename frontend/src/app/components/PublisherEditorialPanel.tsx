              ...
              <div className="rounded-2xl border border-violet-100 bg-white p-4 shadow-sm sm:p-5">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <h4 className="mt-1 break-words text-xl font-bold text-gray-900 [overflow-wrap:anywhere]">
                      {selectedGroup.name}
                    </h4>
                    <p className="mt-1 text-sm text-gray-600">
                      Издатель (аккаунт):{' '}
                      <span className="font-medium break-words text-gray-900 [overflow-wrap:anywhere]">
                        {publisherName}
                      </span>
                    </p>
                  </div>
                      ...
                      <div className="flex flex-col sm:flex-row">
                        ...
                        <div className="min-w-0 flex-1 p-3 sm:p-4">
                          <div className="flex flex-wrap items-center gap-2">
                            <span className="max-w-full truncate rounded-md bg-violet-100 px-2 py-0.5 text-xs font-medium text-violet-800">
                              {post.category}
                            </span>
                          ...
                          <h5 className="mt-1 line-clamp-2 font-semibold text-gray-900 [overflow-wrap:anywhere]">
                            {post.title}
                          </h5>
                          <p className="mt-1 line-clamp-2 text-sm text-gray-600 [overflow-wrap:anywhere]">
                            {post.excerpt}
                          </p>
